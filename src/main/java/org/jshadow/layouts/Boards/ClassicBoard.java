...
public class ClassicBoard implements Board {
     ...
     */
    public ClassicBoard(Position position) {
    ...
    private void drawText(Graphics2D graphics) {
        ...
        graphics.drawString("Player 4", 90, 540);
        graphics.drawString("Player 3", 370, 540);
        graphics.drawString("Instruction:", 550, 300);
        graphics.drawString("1.Press enter to roll dice.", 550, 350);
        graphics.drawString("2.Click on coin to move.", 550, 400);
        graphics.drawString("3.Don't worry, be happy.", 550, 450);
    }
     ...
     * @return Pawns path.
     */
    public Path getPath() { return new ClassicPath(); }
